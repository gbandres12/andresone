      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              {t.about.paragraph1}{" "}
              <strong className="text-foreground">{t.about.paragraph1Bold1}</strong> {t.about.paragraph1And}{" "}
              <strong className="text-foreground">{t.about.paragraph1Bold2}</strong>.
            </motion.p>
            ...
            >
              {t.about.paragraph2}{" "}
              <strong className="text-foreground">{t.about.paragraph2Bold1}</strong>,{" "}
              {t.about.paragraph2Middle}{" "}
              <strong className="text-foreground">{t.about.paragraph2Bold2}</strong>{" "}
